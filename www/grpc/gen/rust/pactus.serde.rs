...
impl serde::Serialize for GetAccountByNumberRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("pactus.GetAccountByNumberRequest", len)?;
        if self.number != 0 {
            struct_ser.serialize_field("number", &self.number)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for GetAccountByNumberRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = GetAccountByNumberRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct pactus.GetAccountByNumberRequest")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<GetAccountByNumberRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut number__ = None;
                ...
                Ok(GetAccountByNumberRequest {
                    number: number__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("pactus.GetAccountByNumberRequest", FIELDS, GeneratedVisitor)
    }
}
